...
gap %>% 
  ...
  labs(title="USA GDP per capita 2000-2025",x="Year",y="GDP per capita")
```
...
gap %>% 
  ...
  labs(title="Distribution of life expectancy in 1935",y=NULL,x="Life expectancy (years)")
```
...
gap %>% 
  filter(year==1935) %>% 
  ggplot(aes(x=lex))+
  geom_density(color="pink",fill="pink", alpha=.5)+
  labs(title="Distribution of life expectancy in 1935",x="Life expectancy (years)")
```
