...
```{r}
ggplot(data=penguins, mapping = aes(x=body_mass_g,y=flipper_length_mm))+geom_point(na.rm=T)+geom_smooth(method=lm, se=T)
```
...
ggplot(data=penguins, 
  ...
  geom_point(mapping=aes(color=species))+
  geom_smooth(method=lm, se=T)+
  labs(title="Title", x="Body Mass (g)", y="Flipper Length (mm)")
```
...
ggplot(data=penguins, mapping=aes(x=species))+
  geom_bar()+
  labs(title="Individuals per species")
```
