...
```{}
cd Desktop/
   54  mv UKWF79ZK016-Alignment-Descriptions.csv genome01_blastn.csv
   55  ls
   56  mv ../
   57  mv genome01_blastn.csv ../Documents/GitHub/BIS15L_W26_mmscriven/lab16/data/blast_results/
   58  cd ../
   59  ls Documents/GitHub/BIS15L_W26_mmscriven/lab16/data/
   60  ls Documents/GitHub/BIS15L_W26_mmscriven/lab16/data/blast_results/

```
   
Load the blast search results into R. 
```{r}
genome01_blastn <- read.csv("data/blast_results/genome01_blastn.csv") %>% clean_names()
...
```{bash}
scc2102-04:~ mmscrive$ ls Desktop/
UKXUYKW0014-Alignment-Descriptions.csv
scc2102-04:~ mmscrive$ mv Desktop/UKXUYKW0014-Alignment-Descriptions.csv blastp_results.csv
scc2102-04:~ mmscrive$ ls Desktop/
scc2102-04:~ mmscrive$ ls
blastp_results.csv	Downloads		Music
Desktop			Library			Pictures
Documents		Movies			Public
scc2102-04:~ mmscrive$ mv blastp_results.csv Documents/GitHub/BIS15L_W26_mmscriven/lab16/data/blast_results/
scc2102-04:~ mmscrive$ ls Documents/GitHub/BIS15L_W26_mmscriven/lab16/data/blast_results/
blastp_results.csv	genome01_blastn.csv
```

2. Read the csv file into R and clean the column names. Save the cleaned data frame as `blastp_results`.

```{r}
blastp_results <- read.csv("data/blast_results/blastp_results.csv") %>% clean_names()
```
